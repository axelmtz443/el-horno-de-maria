...
// Productos compartidos por Caja y Hogaza (mismos precios)
function productosHogCaj(tipo: "caja" | "hogaza"): ProductoCatalogo[] {
  const p = tipo === "caja" ? "cj" : "hg"
  return [
    // Básico
...
export const SECCIONES_CATALOGO = [
  { tipo_pan: "caja" as TipoPan, titulo: "Pan de Caja", subtitulo: "900 gr aprox.", emoji: "🍞", productos: productosHogCaj("caja") },
  { tipo_pan: "hogaza" as TipoPan, titulo: "Pan de Hogaza", subtitulo: "900 gr aprox.", emoji: "🫓", productos: productosHogCaj("hogaza") },
